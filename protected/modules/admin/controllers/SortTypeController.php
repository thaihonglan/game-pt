...
// 			'accessControl', // perform access control for CRUD operations
	...
	{
		$dataProvider=new CActiveDataProvider('SortType');
	 ...
	 * @return SortType the loaded model
	 ...
	 * @param SortType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sort-type-form')
		{
